...
如果有强迫症（对于这一点我还真没），也可以（借鉴同学的做法）采用[第三方平台](https://latex.codecogs.com/)将公式渲染成svg的方式来统一本地与远端的表现形式，即`![equation](url)`，比如：
<center>![equation](https://latex.codecogs.com/gif.latex?\dpi{400}\alpha&space;+&space;\frac{2\beta}{\gamma})</center>
但是实际上这种方法异常麻烦 ：(
