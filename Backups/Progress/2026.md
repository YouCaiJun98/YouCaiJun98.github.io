        ...
        * Q1：现在是否真的没人这么做？如果有人这么做，他们的方法是什么？
            ...
            * 从目前已调研到的学术研究来看，对agent行为的验证主要包括：**任务规划的合理性**、**采取行动的合理性**、**行为结果的合理性**。
            - [] TODOs：
                ...
                * ~~[AGENTGUARD](https://arxiv.org/pdf/2502.09809)~~：本文参考价值较低，只是一篇作业级别的原型报告。该文章设计了一个漏洞挖掘pipeline，通过三个不同的agent相互合作，挖掘当前工具连续执行中的风险项，并形成评估报告。评估报告后续可作为system prompt指导工作流程。
